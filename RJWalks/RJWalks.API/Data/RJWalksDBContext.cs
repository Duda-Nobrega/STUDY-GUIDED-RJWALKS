    ...
    public class RJWalksDBContext(DbContextOptions dbContextOptions) : DbContext(dbContextOptions)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty
                {
                    Id= Guid.Parse("0441f920-bc33-47f8-8a1e-84742b87faa9") ,
                    Name = "Fácil"
                },
                new Difficulty
                {
                    Id= Guid.Parse("f1438eab-4087-4878-b1ef-e273364721b3"),
                    Name = "Média"
                },
                new Difficulty
                {
                    Id= Guid.Parse("0c9cd4ab-3456-486f-a0ee-afea3bbee050"),
                    Name = "Díficil"
                },
            };
