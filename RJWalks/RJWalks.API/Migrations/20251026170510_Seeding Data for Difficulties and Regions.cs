    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0441f920-bc33-47f8-8a1e-84742b87faa9"), "Fácil" },
                    { new Guid("0c9cd4ab-3456-486f-a0ee-afea3bbee050"), "Díficil" },
                    { new Guid("f1438eab-4087-4878-b1ef-e273364721b3"), "Média" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0441f920-bc33-47f8-8a1e-84742b87faa9"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0c9cd4ab-3456-486f-a0ee-afea3bbee050"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f1438eab-4087-4878-b1ef-e273364721b3"));
